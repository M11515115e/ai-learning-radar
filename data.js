window.KNOWLEDGE_RADAR_DATA = {
  ...
  "notes": [
    ...
    {
      "id": "articles/2026-08-10-threads-cloudflare-os.md",
      "title": "Threads｜Cloudflare OS：把公司知識、Agent 與安全工作區開源",
      "date": "2026-08-10",
      "originalUrl": "https://www.threads.com/share/BAYbgr9G07/",
      "source": "Threads",
      "author": "akiraxtwo",
      "topics": [
        "AI Agent",
      ...
      "status": "partially-verified",
      "lowInformation": false,
      "summary": "Threads 貼文介紹 Cloudflare 開源的 Cloudflare OS。官方 repository 將它定位為建立在 Cloudflare Workers 上的 AI productivity environment，提供 Agent chat、公司脈絡、可分享的小型應用程式與 Gatekeepers 安全層；社群貼文的核心方向大致獲官方 README 支持，但「Cloudflare OS」並非官方正式產品名稱以外的泛稱，部署與安全能力仍需依早期版本文件實測。",
      "keyPoints": [],
      "actionableInsights": [],
      "verificationStatus": "partially-verified",
      "verifiedAt": "2026-08-10",
      "coverImage": "assets/public/source-images/2026-08-10-threads-cloudflare-os-cover.png",
      "articleUrl": "articles/2026-08-10-threads-cloudflare-os.html"
    },
    {
      "id": "articles/2026-08-10-threads-zoomit-mac.md",
      "title": "Threads｜Microsoft ZoomIt 正式推出 macOS 版本",
      "date": "2026-08-10",
      "originalUrl": "https://www.threads.com/share/BALOVrHjsD/",
      "source": "Threads",
      "author": "akiraxtwo",
      "topics": [
        "macOS",
      ...
      "status": "verified",
      "lowInformation": false,
      "summary": "Threads 貼文介紹 Microsoft Sysinternals ZoomIt 的 macOS 版本。Microsoft 官方 ZoomitForMac repository 已確認它提供螢幕縮放、即時縮放、畫筆與文字註解、截圖、OCR、螢幕錄影、攝影機子母畫面與捲動全景截圖，並提供 Homebrew 安裝方式。",
      "keyPoints": [],
      "actionableInsights": [],
